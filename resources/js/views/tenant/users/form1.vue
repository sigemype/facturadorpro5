                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div :class="{'has-danger': errors.identity_document_type_id}"
                                    ...
                                    <small v-if="errors.identity_document_type_id" class="text-danger" v-text="errors.identity_document_type_id[0]"></small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div :class="{ 'has-danger': errors.number }" class="form-group">
                                    ...
                                    <small v-if="errors.number" class="text-danger" v-text="errors.number[0]"></small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div :class="{ 'has-danger': errors.names }" class="form-group">
                                    ...
                                    <small v-if="errors.names" class="text-danger" v-text="errors.names[0]"></small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div :class="{ 'has-danger': errors.last_names }" class="form-group">
                                    ...
                                    <small v-if="errors.last_names" class="text-danger" v-text="errors.last_names[0]"></small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div :class="{ 'has-danger': errors.date_of_birth }" class="form-group">
                                    ...
                                    <small v-if="errors.date_of_birth" class="text-danger" v-text="errors.date_of_birth[0]"></small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div :class="{ 'has-danger': errors.personal_email }" class="form-group">
                                    ...
                                    <small v-if="errors.personal_email" class="text-danger" v-text="errors.personal_email[0]"></small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div :class="{ 'has-danger': errors.personal_cell_phone }" class="form-group">
                                    ...
                                    <small v-if="errors.personal_cell_phone" class="text-danger" v-text="errors.personal_cell_phone[0]"></small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div :class="{ 'has-danger': errors.address }" class="form-group">
                                    ...
                                    <small v-if="errors.address" class="text-danger" v-text="errors.address[0]"></small>
                                </div>
                            </div> 
                            ...
                            <div class="col-md-6">
                                <div :class="{ 'has-danger': errors.corporate_email }" class="form-group">
                                    ...
                                    <small v-if="errors.corporate_email" class="text-danger" v-text="errors.corporate_email[0]"></small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div :class="{ 'has-danger': errors.contract_date }" class="form-group">
                                    ...
                                    <small v-if="errors.contract_date" class="text-danger" v-text="errors.contract_date[0]"></small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div :class="{ 'has-danger': errors.corporate_cell_phone }" class="form-group">
                                    ...
                                    <small v-if="errors.corporate_cell_phone" class="text-danger" v-text="errors.corporate_cell_phone[0]"></small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div :class="{ 'has-danger': errors.position }" class="form-group">
                                    ...
                                    <small v-if="errors.position" class="text-danger" v-text="errors.position[0]"></small>
                                </div>
                            </div>
                                                    ...
                                                    <div class="form-group mb-2 mr-2">
                                                        ...
                                                        <template v-if="errors[`default_document_types.${index}.document_type_id`]">
                                                            <div class="form-group" :class="{'has-danger': errors[`default_document_types.${index}.document_type_id`]}">
                                                                <small class="text-danger" v-text="errors[`default_document_types.${index}.document_type_id`][0]"></small>
                                                            </div>
                                                        </template>
                                                    </div>
                                                </td>
                                                    ...
                                                    <div class="form-group mb-2 mr-2">
                                                        ...
                                                        <template v-if="errors[`default_document_types.${index}.series_id`]">
                                                            <div class="form-group" :class="{'has-danger': errors[`default_document_types.${index}.series_id`]}">
                                                                <small class="text-danger" v-text="errors[`default_document_types.${index}.series_id`][0]"></small>
                                                            </div>
                                                        </template>
                                                    </div>
                                                </td>
                                                <td class="series-table-actions text-center">
                                                    <button  type="button" class="btn waves-effect waves-light btn-sm btn-danger" @click.prevent="clickDeleteDefaultDocumentType(index)">
