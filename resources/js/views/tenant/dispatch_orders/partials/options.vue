    ...
    methods: {
        ...
        create() {
            this.$http.get(`/${this.resource}/record/${this.recordId}`)
                .then(response => {
                    ...
                    this.titleDialog = `Orden de despacho registrada:  ${this.form.prefix}-${this.form.number}`
                })
        },
        clickFinalize() {
        ...
        clickPrint(format) {
            if(format== 'receipt'){
                ...
                window.open(`/dispatch-order/receipt/${this.form.id}`, '_blank');
            }else{

                window.open(`/dispatch-order/print/${this.form.external_id}/${format}`, '_blank');
            }
        },
        ...
        clickSendWhatsapp() {
            ...
            let form = {
                ...
                mensaje: "La orden de despacho N° " + this.form.serie + this.form.number + " ha sido generado correctamente"
            }
