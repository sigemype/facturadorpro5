    ...
    methods: {
        ...
        async create() {
            ...
            if (this.recordItem) {
                ...
                await this.changeItem();
                console.log(
                    "🚀 ~ file: item.vue:1441 ~ create ~ this.recordItem:",
                    this.recordItem
                );
        ...
        async clickAddItem() {
            let { affectation_igv_type_id: aff_id, unit_price: un_pr } =
                this.form;
                console.log("🚀 ~ file: item.vue:1682 ~ clickAddItem ~ this.form:", JSON.stringify(this.form))
            aff_id = Number(aff_id);
            console.log("🚀 ~ file: item.vue:1684 ~ clickAddItem ~ aff_id:", aff_id)
            console.log("🚀 ~ file: item.vue:1686 ~ clickAddItem ~ un_pr:", un_pr.toString())
            console.log("🚀 ~ file: item.vue:1686 ~ clickAddItem ~ price_value:", this.form.unit_price_value)
            un_pr = Number(un_pr);
