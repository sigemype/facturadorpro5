                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div :class="{'has-danger': errors.establishment}" class="form-group">
                                ...
                                <small v-if="errors.establishment" class="text-danger"
                        ...
                        <div class="col-lg-2">
                            <div :class="{'has-danger': errors.series_id}" class="form-group">
                                ...
                                <small v-if="errors.series_id" class="text-danger"
                        ...
                        <div class="col-lg-2">
                            <div :class="{'has-danger': errors.date_of_issue}" class="form-group">
                                ...
                                <small v-if="errors.date_of_issue" class="text-danger"
                        ...
                        <div class="col-lg-2">
                            <div :class="{'has-danger': errors.date_of_shipping}" class="form-group">
                                ...
                                <el-date-picker v-model="form.date_of_shipping" :clearable="false" type="date"
                                                value-format="yyyy-MM-dd"></el-date-picker>
                                <small v-if="errors.date_of_shipping" class="text-danger"
                        ...
                        <div class="col-lg-4">
                            <div :class="{'has-danger': errors.customer}" class="form-group">
                                ...
                                <small v-if="errors.customer" class="text-danger"
                        ...
                        <div class="col-lg-2">
                            <div :class="{'has-danger': errors.transport_mode_type_id}" class="form-group">
                                ...
                                <small v-if="errors.transport_mode_type_id" class="text-danger"
                        ...
                        <div class="col-lg-4">
                            <div :class="{'has-danger': errors.transfer_reason_type_id}" class="form-group">
                                ...
                                <small v-if="errors.transfer_reason_type_id" class="text-danger"
                        ...
                        <template v-if="form.transfer_reason_type_id === '09'">
                            <div class="col-lg-3">
                                <div :class="{'has-danger': errors['related.number']}"
                                    ...
                                    <small v-if="errors['related.number']" class="text-danger"
                            ...
                            <div class="col-lg-3">
                                <div :class="{'has-danger': errors['related.document_type_id']}"
                                    ...
                                    <small v-if="errors['related.document_type_id']" class="text-danger"
                        ...
                        <div :class="form.transfer_reason_type_id === '09' ? 'col-lg-12' : 'col-lg-6'">
                            <div :class="{'has-danger': errors.transfer_reason_description}" class="form-group">
                                ...
                                <small v-if="errors.transfer_reason_description" class="text-danger"
                        ...
                        <div class="col-lg-2">
                            <div :class="{'has-danger': errors.unit_type_id}" class="form-group">
                                ...
                                <small v-if="errors.unit_type_id" class="text-danger"
                        ...
                        <div class="col-lg-2">
                            <div :class="{'has-danger': errors.total_weight}" class="form-group">
                                ...
                                <small v-if="errors.total_weight" class="text-danger"
                        ...
                        <div class="col-lg-2">
                            <div :class="{'has-danger': errors.packages_number}" class="form-group">
                                ...
                                <el-input-number v-model="form.packages_number" :max="9999999999" :min="0"
                                                 :precision="0"
                                                 :step="1"></el-input-number>
                                <small v-if="errors.packages_number" class="text-danger"
                        ...
                        <div class="col-lg-6">
                            <div :class="{'has-danger': errors.observations}" class="form-group">
                                ...
                                <small v-if="errors.observations" class="text-danger"
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div :class="{'has-danger': errors.origin}" class="form-group">
                                ...
                                <small v-if="errors.origin" class="text-danger"
                        ...
                        <div class="col-lg-6">
                            <div :class="{'has-danger': errors['origin.address']}" class="form-group">
                                ...
                                <small v-if="errors['origin.address']" class="text-danger"
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div :class="{'has-danger': errors.delivery}" class="form-group">
                                ...
                                <small v-if="errors.delivery" class="text-danger"
                        ...
                        <div class="col-lg-6">
                            <div :class="{'has-danger': errors['delivery.address']}" class="form-group">
                                ...
                                <el-input v-model="form.delivery.address" :maxlength="100"
                                          placeholder="Dirección..."></el-input>
                                <small v-if="errors['delivery.address']" class="text-danger"
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div :class="{'has-danger': errors.dispacher}" class="form-group">
                                ...
                                <small v-if="errors.dispacher" class="text-danger"
                        ...
                        <div class="col-lg-4">
                            <div :class="{'has-danger': errors['dispatcher.number']}" class="form-group">
                                ...
                                <small v-if="errors['dispatcher.number']" class="text-danger"
                        ...
                        <div class="col-lg-4">
                            <div :class="{'has-danger': errors['dispatcher.name']}" class="form-group">
                                ...
                                <small v-if="errors['dispatcher.name']" class="text-danger"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div :class="{'has-danger': errors['driver.identity_document_type_id']}" class="form-group">
                                ...
                                <small v-if="errors['driver.identity_document_type_id']" class="text-danger"
                        ...
                        <div class="col-lg-4">
                            <div :class="{'has-danger': errors['driver.number']}" class="form-group">
                                ...
                                <el-input v-model="form.driver.number" :maxlength="11"
                                          placeholder="Número..."></el-input>
                                <small v-if="errors['driver.number']" class="text-danger"
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr v-for="(row, index) in form.items" :key="index">
                                ...
                                <td class="text-end">{{ row.quantity }}</td>
                                <td class="text-end">
                                    <button class="btn waves-effect waves-light btn-sm btn-danger" type="button"
