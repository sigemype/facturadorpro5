                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group" :class="{'has-danger': errors.date_of_issue}">
                                    ...
                                    <small class="text-danger" v-if="errors.date_of_issue"
                            ...
                            <div class="col-lg-2">
                                <div class="form-group" :class="{'has-danger': errors.date_of_due}">
                                    ...
                                    <small class="text-danger" v-if="errors.date_of_due"
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group" :class="{'has-danger': errors.payment_method_type_id}">
                                    ...
                                    <small class="text-danger" v-if="errors.payment_method_type_id"
                            ...
                            <div class="col-lg-2">
                                <div class="form-group" :class="{'has-danger': errors.exchange_rate_sale}">
                                    ...
                                    <small class="text-danger" v-if="errors.exchange_rate_sale"
                                    ...
                                    <div class="row mt-1">
                                        ...
                                        <div class="col-lg-2 float-right">
                                            <div class="form-group" :class="{'has-danger': errors.perception_number}">
                                                ...
                                                <small class="text-danger" v-if="errors.perception_number"
                                    ...
                                    <div class="row mt-1">
                                        ...
                                        <div class="col-lg-2 float-right">
                                            <div class="form-group" :class="{'has-danger': errors.perception_date}">
                                                ...
                                                <small class="text-danger" v-if="errors.perception_date"
                                    ...
                                    <div class="row mt-1">
                                        ...
                                        <div class="col-lg-2 float-right">
                                            <div class="form-group" :class="{'has-danger': errors.total_perception}">
                                                ...
                                                <small class="text-danger" v-if="errors.total_perception"
