    ...
    <table class="full-width mt-10 mb-10">
        <thead class="">
            <tr class="bg-grey">
                ...
                <th class="border-top-bottom text-center py-2" width="12%">Dscto</th>
                <th class="border-top-bottom text-right py-2" width="12%">P.Neto</th>
                <th class="border-top-bottom text-right py-2" width="12%">P.Venta</th>
            </tr>
        </thead>
        <tbody>
            ...
            @if ($document->total_discount > 0 && $document->subtotal > 0)
                <tr>
                    <td colspan="7" class="text-right font-bold">Sub total:
            ...
            @if ($document->total_discount > 0)
                <tr>
                    ...
                    <td class="text-right font-bold">
                        {{ number_format($document->subtotal - $document->total, 2) }}
                    </td>
                </tr>
            @endif
