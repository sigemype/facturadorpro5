...
<strong>"SIRVASE DEPOSITAR EN NUESTRAS CUENTAS":</strong> 
 @if(in_array($document->document_type->id,['01','03']))
            ...
            @endif
<br><br>
Representación Impresa del <strong>COMPROBANTE ELECTRÓNICO</strong>, generado desde el Sistema del Contribuyente, para visualizar el documento visita: <strong> {!! url('/buscar') !!}</strong> , comprobante emitido desde <strong>www.econtfact.com. </strong></td>
