...
<body>
                ...
                @if ($company->logo)
                    <div class="text-center company_logo_box">
                        <img src="data:{{ mime_content_type(public_path("storage/uploads/logos/{$company->logo}")) }};base64, {{ base64_encode(file_get_contents(public_path("storage/uploads/logos/{$company->logo}"))) }}"
                            class="company_logo" style="max-width: 60%; margin-left: 20%;">
                    </div>
                @endif
            </td>
        </tr>
    ...
    <table class="full-width mt-5" style="font-family: helvetica">
        ...
        <tr>
            <td class="align-top">
                <p class="desc-ticket text-uppercase">Documento por cobrar:</p>
            </td>
            <td>
    ...
    @if ($payments->count())
        ...
        <table class="full-width" style="font-family: 'Courier New', Courier, monospace">
            ...
            @foreach ($payments as $row)
                <tr>
                    <td class="desc-ticket">- {{ $row->date_of_payment->format('d/m/Y') }} -
