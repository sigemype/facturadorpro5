        ...
        <tr>
            ...
            <td class="text-center align-top">
                ...
                @php
                    ...
                    $lot_code = isset($row->item->lots_group) ? collect($row->item->lots_group)->first():null;
                @endphp
                {{
            ...
            <td class="text-center align-top">
                @if(isset($row->item) && isset($row->item->date_of_due))
                    ...
                    <span style="font-size: 9px"> {{ \Carbon\Carbon::parse($row->item->date_of_due)->format('Y-m-d') }}</span><br>
                @endif
