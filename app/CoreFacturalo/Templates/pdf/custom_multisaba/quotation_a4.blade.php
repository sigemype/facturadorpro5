        ...
        @if($company->favicon)
            <td width="20%">
                <div class="company_logo_box">
                    <img src="data:{{mime_content_type(public_path("{$company->favicon}"))}};base64, {{base64_encode(file_get_contents(public_path("{$company->favicon}")))}}" alt="{{$company->name}}" class="company_logo" style="max-width: 150px;">
                </div>
            </td>
        @else
            <td width="20%">
