...
$establishment_original = \App\Models\Tenant\Establishment::find($document->establishment_id);
...
<body>
        ...
        <tr>
            ...
            <td width="20%">
                <div class="company_logo_box">
                    <img src="data:{{mime_content_type(public_path("{$company->favicon}"))}};base64, {{base64_encode(file_get_contents(public_path("{$company->favicon}")))}}" alt="{{$company->name}}" class="company_logo" style="max-width: 250px;">
                </div>
            </td>
            @else
            <td width="20%">
    ...
    @isset($establishment_original->aditional_information)
    <p style="color: red; text-align: center;">{{strtoupper($establishment_original->aditional_information)}} </p>
