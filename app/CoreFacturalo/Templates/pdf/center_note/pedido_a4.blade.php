        ...
        <tbody>
            @foreach ($document->items as $row)
                <tr>
                    ...
                    <td class="text-center align-top">{{ symbol_or_code(symbol_or_code($row->item->unit_type_id)) }}
                    </td>
        ...
        <tr>
            <td width="65%" style="text-align: top; vertical-align: top;">
                ...
                @if ($customer->department_id == 16)
                    <br /><br /><br />
                    @php
                        $description = 'del Comprobante de Pago Electrónico';
                        if (is_object($document)) {
                            if ($document->prefix == 'NV') {
                                $description = 'de la Nota de Venta Electrónica';
                            } else {
