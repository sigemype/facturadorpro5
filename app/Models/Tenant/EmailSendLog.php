...
class EmailSendLog extends ModelTenant
{
    ...
    public function setModelByType($type = 0)
    {
        ...
        if ($type == 1) {
            ...
            $this->relation_model = ProductionOrder::class;
        } elseif ($type == 7) {
            $this->relation_model = DispatchOrder::class;
        }
        return $this;
    }
    ...
    public function scopeProductionOrder($query)
    {
        return $query->where('relation_model', ProductionOrder::class);
    }

    public function scopeDispatchOrder($query)
    {
        return $query->where('relation_model', DispatchOrder::class);
    }
